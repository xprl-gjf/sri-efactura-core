package ec.gob.sri.liquidacion.v1_1_0;
...
public class LiquidacionCompraTest {
    ...
    private static final String xmlFilename = "LiquidacionCompra_V1.1.0.xml";
    ...
    private static Stream<Arguments> getInvalidLiquidacionCompraConfigActions() {
        return Stream.of(
                ...
                config("invalid maquinaFiscal", LiquidacionCompraTest::invalidMaquinaFiscal, "must match \"[^\\n]*\"")
        );
    }
    ...
    private static void invalidMaquinaFiscal(LiquidacionCompra LiquidacionCompra) {
        LiquidacionCompra.getMaquinaFiscal().setModelo("ABC\n123");
    }
}
